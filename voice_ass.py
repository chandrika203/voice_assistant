...
# Libraries
import os #access file & floders 
import time #sys tym
import pyttsx3 #txt to speech
import speech_recognition as sr #speech to txt
from groq import Groq #helps to connect large llm models
from dotenv import load_dotenv #helps to get api key

# api key - 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
# run below in terminal every time u run code
# $env:key_Chandrika_Chavva="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"

# loading the API key from local enviornment for safty purpose
load_dotenv()
GROQ_API_KEY = os.getenv("key_Chandrika_Chavva")
...
@st.cache_resource #recognize all cmds need not to intiliaze again 
def get_recognizer():
    return sr.Recognizer() #obj for speech recognizer lib
...
def main():
    ...
    st.markdown(
        ...
        <p> Powered by GROQ and STREAMLIT * Copyright: Chandrika Chavva</p>
        </div>
        """,
